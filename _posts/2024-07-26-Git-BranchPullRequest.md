...
1. **Branch 메뉴에서 New Branch... 버튼을 클릭하여 브랜치를 생성할 수 있다.**<br>
 ![](https://velog.velcdn.com/images/duwnstj12/post/5158db0d-5c82-465b-bfa5-b455968927cb/image.png)
  
![](https://velog.velcdn.com/images/duwnstj12/post/7a3aff6f-f3d4-4984-930c-3f7a5b2c2367/image.png)

2. **브랜치 목록은 Current branch 탭에서 확인할 수 있다.**<br>
   ![](https://velog.velcdn.com/images/duwnstj12/post/dd6322ac-7320-425d-9375-5295765a95a8/image.png)
...
3. **새 브랜치의 history(커밋 역사)를 확인해보면 main의 history와 같다는 것을 알 수 있다.**<br>
   ...
   ![](https://velog.velcdn.com/images/duwnstj12/post/a11646fb-e82a-4048-854f-f836f81dbdaa/image.png)
...
- **Current branch 탭에서 브랜치를 스왑할 수 있다.**<br>
  ![](https://velog.velcdn.com/images/duwnstj12/post/5dc92e35-5da2-459a-8ae4-821c81bf7393/image.png)
...
- **merge 커밋을 생성할 브랜치로 전환한다.**<br>
  ...
  ![](https://velog.velcdn.com/images/duwnstj12/post/3cef82e7-9ca5-45db-b6b3-3c479bf8cd18/image.png)

- **merge 할 브랜치를 선택한다.**<br>
  Create a merge commit 버튼을 클릭하여 새로운 merge 커밋을 생성한다.
  ![](https://velog.velcdn.com/images/duwnstj12/post/71de75bf-b915-4d57-be1d-56098dd1dcc5/image.png)
...
- **GitHub에서 Pull request 탭의 New pull request 또는 New 버튼을 클릭한다.**<br>
  ![](https://velog.velcdn.com/images/duwnstj12/post/5be27ce4-a24f-42bb-b4a8-49b84b0478b6/image.png)
...
- **base 브랜치에는 변경 사항을 반영할 브랜치를, compare 브랜치에는 변경 사항이 있는 브랜치를 선택한다.**<br>
  ...
  ![](https://velog.velcdn.com/images/duwnstj12/post/6dd36740-baaa-4914-802e-e09e9ca81449/image.png)

- pr을 생성하고 나면 Pull request 창에 pr이 나타난다<br>
  ![](https://velog.velcdn.com/images/duwnstj12/post/af373a3f-ab52-4f21-9bec-5cf3406f8ed8/image.png)
...
- `Files changed` 탭을 통해 변경 사항이 있는 파일을 확인하고 피드백을 작성할 수 있다.
 ![](https://velog.velcdn.com/images/duwnstj12/post/ad136e3a-9357-4cc0-b9cd-25c0453834f0/image.png)
...
- 확인이 끝난 파일은 `viewed`를 통해 체크 해 둘 수 있다.<br><br>
  ![](https://velog.velcdn.com/images/duwnstj12/post/20a3f66d-588a-4191-9b5b-f6549fb2c58d/image.png)
...
- 파일 확인이 끝나면 Finish your review를 클릭하고 최종 피드백을 작성한다.(팀원들 입장)
  ...
  - `Request changes`는 merge 이전에 수정할 것을 요청할 때 사용한다.
    ![](https://velog.velcdn.com/images/duwnstj12/post/0d92137c-d59d-4ba3-a5ab-0ecc42cf7623/image.png)
...
![](https://velog.velcdn.com/images/duwnstj12/post/6d49010b-2626-4cc8-ad23-3009b5d063c6/image.png)
