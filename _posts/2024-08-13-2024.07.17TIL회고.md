...
1. **클라이언트와 서버** :
   ...
   - 서버 : 웹 페이지,이미지,데이터 등 클라이언트가 요청한 리소스를 제공한다.<br>서버는 클라이언트의 요청을 처리하고 적합한 응답을 반환해준다.<br>
...
- 구글 폰트 사이트에 접속해서 원하는 폰트를 선택한다.
  ![](https://velog.velcdn.com/images/duwnstj12/post/4cf52bff-40cf-465d-8607-46257eb8c7b8/image.png)

- 우측 상단에 Getfont버튼을 클릭한다.
 ![](https://velog.velcdn.com/images/duwnstj12/post/a535e5a8-4242-4216-9476-736f1fbf6ac7/image.png)

- 화면 오른쪽의`<>Get embed code`버튼을 클릭한다.
  ![](https://velog.velcdn.com/images/duwnstj12/post/9d66a429-8b7f-44bf-938e-aa58370d01fe/image.png)

- 오른쪽의 Web탭에서 `import`버튼을 클릭한다.
 ![](https://velog.velcdn.com/images/duwnstj12/post/7c06eab7-1706-4d82-893e-f9b4315dc032/image.png)
